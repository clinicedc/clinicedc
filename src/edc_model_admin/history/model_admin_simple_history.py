...
class SimpleHistoryAdmin(BaseSimpleHistoryAdmin):
    ...
    def dashboard(self, obj) -> str | None:  # noqa: ARG002
        if callable(self.view_on_site):
            return format_html_lazy('<A href="{url}">Dashboard</A>', url=self.view_on_site())
        return None
    ...
    def history_view_title(self, request, obj):  # noqa: ARG002
