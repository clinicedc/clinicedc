...
class TestMoveAppointment(TestCase):
    ...
    def test_appointments_and_related_visits_resequence_after_appointment_is_deleted(
        self,
    ):
    ...
    def test_next_getter(self):
        ...
        self.assertEqual(
            get_next_appointment(appointment, include_interim=True).visit_code_sequence,
            1,
        )
        self.assertEqual(
            ["1000.0", "1000.1", "1000.2", "1000.3", "2000.0", "3000.0", "4000.0"],
